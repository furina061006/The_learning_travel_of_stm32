...
int main(void)
{
	...
	WrArray[0] = 0x00;
	MPU6050H_WriteRegs(0x6B, WrArray, 1);

	// WrArray[0] = 0xAA;
	// MPU6050S_WriteRegs(0x19, WrArray, 1);

	// MPU6050S_ReadRegs(0x19, ReArray, 1);

	// OLED_ShowHexNum(2,1,ReArray[0],2);

	// OLED_ShowHexNum(2,1,MPU6050H_GetID(),2);

	while (1)
	{
		MPU6050H_GetData(DataArray);
